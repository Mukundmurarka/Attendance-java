...
public class Teacher_ragistration extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sqll="INSERT INTO `teacherdetail`(`FIRST NAME`, `LAST NAME`, `ADDRESS`, `EMAILID`, `MOBILE`) VALUES (?,?,?,?,?)";
            ...
            pst.setString(3, teaaddress.getText());
            pst.setString(4, teaemail.getText());
            pst.setInt(5,Integer.parseInt(tmobile.getText()));
            pst.executeUpdate();
